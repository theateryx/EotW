...
The sensitivity (true positive rate) of the train set is 97.42%, and the test set improved at 99.63%. 
The specificity (true negative rate) of the train set is 98.97%, and the test set is 83.11%.
...
The sensitivity (true positive rate) of the train set is 97.40%, and the test set improved at 94.96%
